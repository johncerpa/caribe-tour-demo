import 'package:caribe_tour/presentation/flutter_list/src/choice_chip_widget.dart';
import 'package:caribe_tour/presentation/flutter_list/src/search_field_widget.dart';
...
class FilterListDialog {
  static Future<List<String>> display(
    ...
    final List<String> list = await showDialog(
      context: context,
